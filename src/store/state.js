...
export default {
  ...
  user: {},//保存当前用户信息
  username: storageUtils.readName(),//保存用户name
  roles: [],//记录用户角色
  authorities: [],//记录用户权限
  authorities3: [],//记录请求资源
  units: [
