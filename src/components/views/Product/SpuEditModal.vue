<template>
  <div class="spu-edit-modal-div">
    <div class="spu-edit-modal-main">
      ...
      <div class="spu-edit-modal-group ">
        ...
        <div class="spu-edit-modal-item-content spu-catalog-div">
          <div class="form-control spu-edit-modal-catalog thumbnail" ><span class="spu-catalog-value">hhhh</span><span class="spu-edit-modal-list glyphicon glyphicon-triangle-bottom"></span></div>
      ...
      <div class="spu-edit-modal-group">
        ...
        <div class="spu-edit-modal-item-content spu-down-list-div">
          <div class="form-control spu-down-list thumbnail" >
            ...
            <span class="spu-edit-modal-list glyphicon glyphicon-triangle-bottom"></span>
          </div>
      ...
      <div class="spu-edit-modal-group">
        ...
        <div class="spu-edit-modal-item-content spu-down-list-div">
          <div class="spu-attr-list ">
            <div class="spu-attr-content form-control spu-down-list thumbnail " ><span class="spu-attr-name">hhhh</span><span class="spu-edit-modal-list glyphicon glyphicon-triangle-bottom"></span></div>
      ...
      <div class="spu-edit-modal-group">
        ...
        <div class="spu-edit-modal-item-content">
          <div class="btn btn-success form-control">修改</div>
        </div>
      </div>
...
<script>
  ...
  export default {
    ...
    mounted(){
      ...
      //是否显示分类选择框
      $('.spu-edit-modal-catalog').click(function(event){
        $('.spu-catalog-choose-list').toggle();
        $('.spu-edit-modal-catalog').addClass('spu-edit-modal-catalog-hover');
      });
      $('.spu-catalog-div').mouseleave(function(){
        $('.spu-catalog-choose-list').hide();
        $('.spu-edit-modal-catalog').removeClass('spu-edit-modal-catalog-hover');
      });
...
<style>
  ...
  .spu-edit-modal-item-title-div-textArea{

  }
  .spu-down-list,
  .spu-edit-modal-catalog{
    height: 35px;
    border-color: #cccccc;
    line-height: 35px;
    font-size: 15px;
